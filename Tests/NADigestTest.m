...
- (void)test {
  ...
  XCTAssertEqualObjects(SHA256, expected256);
  
  NSData *SHA3_384 = [NADigest digestForData:data algorithm:NADigestAlgorithmKeccak_384];
  ...
  NSData *SHA3_512 = [NADigest digestForData:data algorithm:NADigestAlgorithmKeccak_512];
  ...
  XCTAssertEqualObjects(SHA3_512, expected512);
}
